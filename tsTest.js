...
function renderRepositoryData(reposHeader, reposDetails) {
    ...
    let headerFragment = new DocumentFragment;
...
function returnElement(elementType, leadText, dataString, className, idName, iterator) {
    ...
    if (idName)
        returnElement.setAttribute('id', idName);
    if (className)
        returnElement.setAttribute('class', className);
